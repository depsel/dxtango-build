...
// browser-route-module:routes/_admin/route.tsx?browser
init_Buffer();
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin/route.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711947479005.243";
}
function AdminLayout() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ClientOnly, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AuthGuard, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, { maxW: "2xl", sx: {
      my: 4
...
//# sourceMappingURL=/build/routes/_admin-RN2A2IMC.js.map
