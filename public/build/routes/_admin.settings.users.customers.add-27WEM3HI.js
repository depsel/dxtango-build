...
// browser-route-module:routes/_admin.settings.users.customers.add/route.tsx?browser
init_Buffer();
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711474084156.413";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin.settings.users.customers.add/components/success.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711994281974.8794";
}
var Success = (props) => {
  _s();
  const {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("form", { noValidate: true, onSubmit: handleSubmit(onSubmit), children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CommonCard, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid, { templateColumns: {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(GridItem, { colSpan: {
        md: 2
      }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Heading, { size: "sm", textTransform: "uppercase", children: "Informaci\xF3n del Cliente" }, void 0, false, {
        fileName: "src/app/routes/_admin.settings.users.customers.add/components/success.tsx",
        lineNumber: 145,
        columnNumber: 15
      }, this) }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin.settings.users.customers.add/components/index.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711474084156.1677";
}
var Form = (props) => {
  const {
    typeSettings
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin.settings.users.customers.add/route.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711474084156.3215";
}
function Add() {
  _s2();
...
//# sourceMappingURL=/build/routes/_admin.settings.users.customers.add-27WEM3HI.js.map
