...
// browser-route-module:routes/_admin.settings.users.vendors.$id.edit/route.tsx?browser
init_Buffer();
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin.settings.users.vendors.$id.edit/components/loading.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711474084156.6257";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711474084156.8892";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin.settings.users.vendors.$id.edit/components/success.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712028233686.593";
}
var Success = (props) => {
  _s();
  const {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("form", { noValidate: true, onSubmit: handleSubmit(onSubmit), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Box, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(CommonCard, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Grid, { templateColumns: {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(GridItem, { colSpan: {
        md: 2
      }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Heading, { size: "sm", textTransform: "uppercase", children: "Informaci\xF3n del Vendedor" }, void 0, false, {
        fileName: "src/app/routes/_admin.settings.users.vendors.$id.edit/components/success.tsx",
        lineNumber: 169,
        columnNumber: 15
      }, this) }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin.settings.users.vendors.$id.edit/components/index.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711474084156.5554";
}
var FormEdit = (props) => {
  const {
    typeSettings,
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"src/app/routes/_admin.settings.users.vendors.$id.edit/route.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1711474084156.7979";
}
function Edit() {
  _s2();
...
//# sourceMappingURL=/build/routes/_admin.settings.users.vendors.$id.edit-VFGFO3M6.js.map
