...
const DEFAULT_PROGRAM_DOWNLOAD_PATH = path$1.join(dataPath, "downloads");
const DEFAULT_PROGRAM_DISABLE_SYSTEM_FILE = path$1.join(process.cwd(), "disable_system.txt");
